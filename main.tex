...
\begin{table}[h!]
	...
	\begin{tabular}{l l l}
		\toprule
		Název & Výrobce & Oficiální webové stránky \\
		\midrule
		Oracle SQL Developer Data Modeler & Oracle Corporation & \url{http://www.oracle.com/technetwork/developer-tools/datamodeler/overview/index.html} \\
		Toad Data Modeler & & \\
		SQL Server Management Studio & & \\
		Visual Paradigm & & \\
		StarUML 2 & & \\
...
\begin{table}[h!]
	...
	\begin{tabular}{|l | l | p{5cm} |}
		...
		Název & Výrobce & Oficiální webové stránky \\
		\midrule
		Oracle Database & Oracle Corporation & \url{https://www.oracle.com/database/} \\
		Microsoft SQL Server & Microsoft & \url{https://www.microsoft.com/en-us/sql-server/default.aspx} \\
		DB2 & IBM & \url{https://www.ibm.com/analytics/us/en/technology/db2/} \\
		PostgreSQL & The PostgreSQL Global Development Group & \url{https://www.postgresql.org/} \\
