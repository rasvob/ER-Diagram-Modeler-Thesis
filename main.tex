...
\section{Popis a srovnání stávajících CASE nástrojů pro modelování relačních databází}
	V dnešní době je využití CASE nástrojů v mnoha fázích softwarovém procesu de~facto standardem. Jinak tomu samozřejmě není ani u návrhu datových modelů. Na trhu nalezneme celou řadu nástrojů, od komerčních po open-source projekty, podporujících tvorbu ER diagramů, ve většině z nich je k dispozici i generování DDL skriptů na základě vytvořeného modelu.
