...
Druhá část bakalářské práce se zabývá návrhem a implementací grafického editoru vyvíjeného nástroje, včetně synchronizace diagramů s relačním schématem. V práci je detailně popsáno fungování klíčových částí grafického editoru pro práci s ER digramy, včetně problematiky algoritmizace některých činností. Datová vrstva pro přístup k sysémovému katalogu DBMS je navržena s ohledem na možná budoucí rozšíření o podporu dalších DBMS. Návrh obou částí je doplněn o části třídního diagramu umožňující snazší popis struktury těchto částí.
...
Téma bakalářské práce pro mne bylo velice přínosné, protože jsem se díky němu naučil pracovat s mnoha technologiemi v oblasti vývoje aplikací pro platformu Microsoft Windows. Díky této práci jsem nabyl nové znalosti také v oblasti správy relačních databází a aplikace návrhových vzorů v rámci návrhu rozsáhlejší aplikace.
