...
\section{Návrh a implementace grafického editoru ER diagramů}
	Grafický editor představuje jádro celého CASE nástroje, protože většina operací, které nástroj umožňuje, je prováděna prostřednictvím jeho rozhraní. 
	
	\subsection{Implementace nástroje}
	Nástroj je implementován jako desktopová aplikace určena pro operační systém Microsoft Windows, konkrétně se jedná o WPF aplikaci, pro její implementaci byl použit programovací jazyk C\#. Použití WPF umožňuje oddělit prezentační vrstvu od vrstvy aplikační logiky 
