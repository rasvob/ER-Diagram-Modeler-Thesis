...
Dodnes nepředstavuje žádná z notací standard v oblasti modelování databází, což je nejvíce patrné na celé řadě CASE nástrojů, které používají mnohdy svou vlastní notaci či dokonce kombinaci symbolů z několika různých notací.
	...
	\begin{figure}[!h]
		...
		\caption{Bachmanův diagram \cite{wikiDsd}}
	\end{figure}
	...
	\begin{figure}[!h]
		...
		\caption[Srovnání DSD a ERD]{Srovnání DSD a ERD a) Data structure diagram b) ER diagram \cite{chenERD}}
	\end{figure}
	...
	\begin{figure}[!h]
		...
		\caption{Znázornění entit podle Chenovy notace \cite{erdSymbols}}
	\end{figure}
	...
	\begin{figure}[!h]
		...
		\caption{Znázornění vztahů podle Chenovy notace \cite{erdSymbols}}
	\end{figure}
	...
	\begin{figure}[!h]
		...
		\caption{Znázornění atributů podle Chenovy notace \cite{erdSymbols}}
	\end{figure}
	...
	Stejně jako se vyvíjely potřeby návrhu datových modelů, vznikaly i nové notace ER diagramu. Cílem nově vznikající notací, zejména v průběhu 80-tých let, bylo odstranění některých problémů již existujících notací. 
	...
	Jak už bylo zmíněno, notací existuje celá řada. Jednotlivé notace se v mnoha směrech liší, v následující kapitole jsou vybrané notace popsány, včetně příkladu, kdy je modelovaná situace
