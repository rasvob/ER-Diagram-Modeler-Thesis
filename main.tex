...
\section{Návrh a implementace grafického editoru ER diagramů}
	...
	Nástroj je implementován jako desktopová aplikace určena pro operační systém Microsoft Windows, konkrétně se jedná o WPF aplikaci, pro její implementaci byl použit programovací jazyk C\#. Výhoda WPF spočívá v přehledném oddělení prezentační a aplikační logiky 
