...
\section{Návrh a implementace grafického editoru ER diagramů}
	...
	WPF je použito z důvodu snadného oddělení prezentační a aplikační vrstvy při zachování jednoduchosti událostmi řízeného programování jako je tomu u WinForms aplikací. 
